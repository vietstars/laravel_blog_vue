...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Chameleon Laravel</title>
    <link rel="apple-touch-icon" sizes="180x180" href="/public/theme-assets/images/ico/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/public/theme-assets/images/ico/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/public/theme-assets/images/ico/favicon-16x16.png">

    <link href="https://fonts.googleapis.com/css?family=Muli:300,300i,400,400i,600,600i,700,700i%7CComfortaa:300,400,700" rel="stylesheet">
    <link href="/public/css/line-awesome.min.css" rel="stylesheet">
    <!-- BEGIN VENDOR CSS-->
  ...
  <body class="vertical-layout vertical-menu 2-columns menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns"><!-- data-color="bg-chartbg" --> 
    <!-- fixed-top-->
  <div id="app">
          ...
          <div class="collapse navbar-collapse show" id="navbar-mobile">
            <ul class="nav navbar-nav mr-auto float-left">
              ...
              <li class="nav-item d-none d-md-block">
                <a class="nav-link nav-link-expand" href="#" @click.prevent="toggleFullScreen()"><i class="ficon ft-maximize"></i></a>
              </li>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true" data-img="/public/theme-assets/images/backgrounds/02.jpg">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="/"><img class="brand-logo" alt="Chameleon admin logo" src="/public/theme-assets/images/logo/logomark.min.svg"/>
            <h3 class="brand-text">Laravel Chameleon</h3></a></li>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="nav-item" :class="{ active: page === 'dashboard' }">
            <router-link to="/dashboard"><!-- <a href="dashboard.html"> -->
              <i class="ft-home"></i>
              <span class="menu-title">Dashboard</span>
            </router-link><!-- </a> -->
          </li>
          <li class="nav-item" :class="{ active: page === 'cat-list' }">
            <router-link to="/category-list"><!-- <a href="category-list.html"> -->
              <i class="ft-pie-chart"></i>
              <span class="menu-title">Category</span>
            </router-link><!-- </a> -->
          </li>
          <li class="nav-item" :class="{ active: page === 'post-list' }">
            <router-link to="/post-list"><!-- <a href="post"> -->
              <i class="ft-layers"></i>
              <span class="menu-title">Post</span>
            </router-link><!-- </a> -->
          </li>
          <li class="nav-item" :class="{ active: page === 'icon-list' }"><!-- <a href="icon"> -->
            <router-link to="/icon">
    ...
    <admin-main style="min-height: calc( 100vh - 118.5px );"></admin-main>
